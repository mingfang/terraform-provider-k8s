...
<details>
<summary>session_affinity_config</summary><blockquote>

    

    
<details>
<summary>client_ip</summary><blockquote>
...
resource "k8s_core_v1_service" "this" {
  ...
  spec {
    cluster_ip                  = "TypeString"
    external_ips                = ["TypeString"]
    external_name               = "TypeString"
    external_traffic_policy     = "TypeString"
    health_check_node_port      = "TypeInt"
    load_balancer_ip            = "TypeString"
    ...
    publish_not_ready_addresses = "TypeBool"
    selector                    = { "key" = "TypeString" }
    session_affinity            = "TypeString"
