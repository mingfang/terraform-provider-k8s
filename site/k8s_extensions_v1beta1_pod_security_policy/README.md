...
```hcl
resource "k8s_extensions_v1beta1_pod_security_policy" "this" {
...
volumes is a white list of allowed volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use '*'.ypeInt
