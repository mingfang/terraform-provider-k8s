...
Populated by the system. Read-only. More info: http://kubernetes.io/docs/user-guide/identifiers#uidsy. More info: http://kubernetes.io/docs/user-guide/identifiers#uidsr
