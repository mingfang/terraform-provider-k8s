...
Type of daemon set update. Can be "RollingUpdate" or "OnDelete". Default is RollingUpdate.espace to use. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
## storageos
...
Type of daemon set update. Can be "RollingUpdate" or "OnDelete". Default is RollingUpdate.ys must be defined
#### secret_name
