//GENERATE DYNAMIC//k8s_rbac_authorization_k8s_io_v1_cluster_role_binding//count = var.cluster_role_rules == null ? 0 : 1//ignore_changes = [metadata]
resource "k8s_rbac_authorization_k8s_io_v1_cluster_role_binding" "this" {
  ...
  metadata {
    ...
    dynamic "managed_fields" {
      for_each = lookup(local.k8s_rbac_authorization_k8s_io_v1_cluster_role_binding_parameters, "managed_fields", [])
      content {
