...
# resource "k8s_node_k8s_io_v1alpha1_runtime_class"
...
<details>
<summary>overhead</summary><blockquote>
...
<details>
<summary>scheduling</summary><blockquote>
...
```hcl
resource "k8s_node_k8s_io_v1alpha1_runtime_class" "this" {
  ...
  spec {
    ...
    overhead {
      pod_fixed = { "key" = "TypeString" }
    }
    runtime_handler = "TypeString*"
