...
<details>
<summary>recommenders</summary><blockquote>
...
```hcl
resource "k8s_autoscaling_k8s_io_v1_vertical_pod_autoscaler" "this" {
  ...
  spec {
    ...
    resource_policy {
      ...
      container_policies {
        ...
        controlled_resources = ["TypeString"]
        controlled_values    = "TypeString"
